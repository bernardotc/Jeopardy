...
public class Controller extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (operation.equals("login") || operation.equals("signin") || operation.equals("confirm") || operation.equals("changePass") || operation.equals("sendMail") || operation.equals("salir")) {
            url = "/login-signin";
